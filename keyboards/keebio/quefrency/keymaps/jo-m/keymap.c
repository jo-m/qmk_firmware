...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT_65_with_macro(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  XP(ue,UE),_______,  XP(oe,OE),_______,  _______,  _______,  _______,  _______,  \
    _______,  _______,  _______,  XP(ae,AE),X(SNEK),  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  \
